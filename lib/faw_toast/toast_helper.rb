...
module FawToast
  module ToastHelper
    ...
    def toast_container
      content_tag :div, id: "toast-container", class: "faw-toast-container faw-toast-#{FawToast.configuration.position}" do
        render_toast
      end
    end
    ...
    def toast_css_variables
      ...
      content_tag :style do
        ":root { --faw-toast-duration: #{FawToast.configuration.duration_seconds}s; }".html_safe
      end
    end
  end
end
